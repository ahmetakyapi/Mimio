      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-[200px] p-6 rounded-2xl mx-4 my-6"
          ...
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-4"
            style={{ background: "rgba(209, 80, 60,0.1)", border: "1px solid rgba(209, 80, 60,0.2)" }}>
          ...
          <button
            ...
            style={{
              background: "linear-gradient(135deg, #0f6e63, #35b0a0)",
              color: "#fff",
              boxShadow: "0 4px 14px rgba(15, 110, 99,0.35)",
            }}>
            Tekrar Dene
          </button>
          {this.state.error && (
            <details className="mt-4 w-full max-w-md">
              ...
              <pre className="text-xs text-(--color-accent-red) mt-2 p-3 rounded-lg overflow-auto"
                style={{ background: "rgba(209, 80, 60,0.06)", border: "1px solid rgba(209, 80, 60,0.1)" }}>
