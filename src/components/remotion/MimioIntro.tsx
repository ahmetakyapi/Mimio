...
const DARK = {
  ...
  textSoft: "#94a3b8",
  textMuted: "#64748b",
  glowIndigo: "rgba(15, 110, 99,0.14)",
  glowPurple: "rgba(20, 132, 122,0.13)",
} as const;
...
const LIGHT = {
  ...
  textSoft: "#475569",
  textMuted: "#94a3b8",
  glowIndigo: "rgba(15, 110, 99,0.10)",
  glowPurple: "rgba(20, 132, 122,0.08)",
} as const;
        ...
        >
          <div
            style={{
              ...
              height: 20,
              borderRadius: 6,
              background: "linear-gradient(135deg, #0f6e63, #14847a)",
              display: "flex",
              alignItems: "center",
