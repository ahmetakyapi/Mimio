...
const DARK = {
  ...
  textSoft: "#8fa1b2",
  textMuted: "#65788a",
  glowIndigo: "rgba(29, 90, 140,0.14)",
  glowPurple: "rgba(42, 114, 172,0.13)",
} as const;
...
const LIGHT = {
  ...
  textSoft: "#4a6072",
  textMuted: "#8fa1b2",
  glowIndigo: "rgba(29, 90, 140,0.10)",
  glowPurple: "rgba(42, 114, 172,0.08)",
} as const;
        ...
        >
          <div
            style={{
              ...
              height: 20,
              borderRadius: 6,
              background: "linear-gradient(135deg, #1d5a8c, #2a72ac)",
              display: "flex",
              alignItems: "center",
