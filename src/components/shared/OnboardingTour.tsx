...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    icon: Users,
    color: "#2a72ac",
    gradient: "linear-gradient(135deg, #2a72ac, #b8503f)",
  ...
  },
  {
    ...
    icon: Gamepad2,
    color: "#3f7d4f",
    gradient: "linear-gradient(135deg, #3f7d4f, #1d5a8c)",
  ...
  },
  {
    ...
    icon: Stethoscope,
    color: "#2a72ac",
    gradient: "linear-gradient(135deg, #2a72ac, #1d5a8c)",
  ...
  },
  {
    ...
    icon: BarChart3,
    color: "#b8763a",
    gradient: "linear-gradient(135deg, #b8763a, #a8392c)",
