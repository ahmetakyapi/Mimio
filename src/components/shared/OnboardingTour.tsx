...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    icon: Users,
    color: "#14847a",
    gradient: "linear-gradient(135deg, #14847a, #c4614a)",
  ...
  },
  {
    ...
    icon: Gamepad2,
    color: "#7aac3a",
    gradient: "linear-gradient(135deg, #7aac3a, #0d5f56)",
  ...
  },
  {
    ...
    icon: Stethoscope,
    color: "#14847a",
    gradient: "linear-gradient(135deg, #14847a, #0f6e63)",
  ...
  },
  {
    ...
    icon: BarChart3,
    color: "#c07c2c",
    gradient: "linear-gradient(135deg, #c07c2c, #d1503c)",
