...
export function SessionSetSummary({ sessionSet, onClose, onNewSet }: SessionSetSummaryProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ background: "rgba(8,13,12,0.92)", backdropFilter: "blur(8px)" }}>
      <div className="relative w-full max-w-md mx-4 rounded-3xl overflow-hidden" style={{ background: "linear-gradient(160deg, #0e1a28 0%, #0a1622 100%)", border: "1px solid rgba(43, 98, 245,0.25)", boxShadow: "0 24px 80px rgba(0,0,0,0.7)" }}>
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="rounded-2xl p-4 text-center" style={{ background: "rgba(43, 98, 245,0.08)", border: "1px solid rgba(43, 98, 245,0.2)" }}>
            ...
            <span className="font-extrabold tabular-nums" style={{ fontSize: "3.5rem", lineHeight: 1, background: "linear-gradient(135deg, #4d7dff, #4d7dff)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              {total}
            </span>
